...
class GroupGLKA(nn.Module):
    def __init__(self, n_feats):
        ...
        self.CAB = CAB(num_feat=n_feats, compress_ratio=3, squeeze_factor=30, conv=nn.Conv2d)
        ...
        self.X5 = nn.Conv2d(n_feats, n_feats, 3, 1, 1, groups=n_feats)
